...
// Optional: If using Framer Motion for animation, uncomment below
...
export const HeroSection = () => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/80 via-white/60 to-transparent pointer-events-none" aria-hidden="true" />
      {/* Main Content */}
  <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center h-full px-4 sm:px-8 lg:px-20 py-4 gap-6 w-full max-w-7xl mx-auto">
        ...
        <div className="text-center lg:text-left max-w-xl animate-fadeIn flex flex-col justify-center h-full">
          <p className="font-semibold text-[#1eb7b1] tracking-wide mb-2" style={{fontSize: 'clamp(1rem, 2vw, 1.75rem)'}}>
            Welcome to
          </p>
          <h1 className="font-extrabold text-[#222] leading-tight drop-shadow-lg mb-4" style={{fontSize: 'clamp(2rem, 5vw, 3.5rem)'}}>
          ...
          <p className="max-w-[600px] mx-auto lg:mx-0 font-normal text-[#333] leading-relaxed mb-6" style={{fontSize: 'clamp(0.9rem, 2vw, 1.25rem)'}}>
        ...
        {/* Banner main image - Always flush with bottom edge and responsive to height */}
        <div className="relative w-full lg:w-auto flex-1 h-full flex items-end justify-center">
          <img
            className="absolute left-1/2 -translate-x-1/2 xl:top-32 lg:top-10 top-0 bottom-0 w-full max-w-[220px] sm:max-w-[320px] md:max-w-[420px] lg:max-w-[539px] h-full max-h-[calc(100vh-80px)] object-contain"
